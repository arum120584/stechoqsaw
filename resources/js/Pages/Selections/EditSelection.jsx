...
export default function EditSelection({ auth }) {
    const data = usePage().props;

    const [name, setName] = useState(data.selection.name);
    const [status, setStatus] = useState(data.selection.status);
    const [jobId, setJobId] = useState(data.selection.job_id);

    const updateSelection = (e) => {
        e.preventDefault();
        router.visit(`/selection/update/${data.selection.id}`, {
            method: "put",
            data: {
                name: name,
                status: status,
